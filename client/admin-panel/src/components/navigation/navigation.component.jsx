...
import img1 from "../../assets/img/pexels-bran-sodre-2622901.jpg";
  ...
  return (
    <nav className="navbar navbar-light">
      <div className="container-fluid">
        <button
          className={isopen && screenwidth < 500 ? "navbar-toggler tog tog-small" : "navbar-toggler tog"}
          type="button"
          onClick={() => {
            setopen(!isopen);
          }}
        ...
        <div className="nav-leftside">
          ...
          <div className="dropdown">
            ...
            <ul className="dropdown-menu dropdown-menu-shadow" aria-labelledby="dropdownMenuButton3">
              <li>
