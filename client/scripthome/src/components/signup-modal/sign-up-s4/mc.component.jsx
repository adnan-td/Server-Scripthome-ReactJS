...
import CloseBlack from "../../../assets/Modal/sign-up/x-close-black.svg";
          ...
          <div className="uploading-div">
            ...
            <div className="uping-content">
              ...
              <div className="upload-status">
                ...
                <p className="uping-percentage">70%</p>
              </div>
            </div>
            <button className="delete-pic-button">
              <img src={CloseBlack} className="close-icon-black" alt="" />
            </button>
          </div>
        </div>
