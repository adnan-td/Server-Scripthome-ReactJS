      ...
      <div className="Script-Modal" onClick={(e) => e.stopPropagation()}>
        <div className="header-wrapper-mod">
          ...
          <div className="h-content-div">
            ...
            <p className="h-content-2">It looks like you're using an ad blocker. That's okay. Who doesn't? But without advertising-income, we can't keep making this site awesome.</p>
          </div>
        </div>
