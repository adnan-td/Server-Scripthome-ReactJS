      ...
      <div className="Script-Modal" onClick={(e) => e.stopPropagation()}>
        <div className="header-wrapper">
          ...
          <div className="h-content-div">
            ...
            <p className="h-content-2">On Scripthome we daily upload scripts for the most popular games.</p>
          </div>
        ...
        <div className="bottom-button">
          <button className="next-button" onClick={handleClose}>Complete Tour</button>
        </div>
      </div>
    </div>
  );
